...
class MealInstructionsVC: RBActivityIndicatorVC {
    ...
    let instructionLabel    = RBBodyLabel(textAlignment: .left)
    let youTubeButton       = RBButton(backgroundColor: .systemRed, title: Title.ytlink, cornerRadius: 14)
    let sourceButton        = RBButton(backgroundColor: .systemGreen, title: Title.sourcelink, cornerRadius: 14)
