...
class CategoryCell: UITableViewCell {
    ...
    let categoryImageView           = RBMealImageView(frame: .zero)
    let categoryLabel               = RBTitleLabel(textAlignment: .left, fontSize: 24)
    let categoryDescriptionLabel    = RBBodyLabel(textAlignment: .left)
